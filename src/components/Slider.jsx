...
height: 100%; display: flex; transition: all 0.5s ease;
...
const Image = styled.img` height:80%;background-size:cover; z-index:3; `
...
if(direction === "left"){ setSlideIndex(slideIndex > 0 ? slideIndex-1 : 2)}
  ...
  setSlideIndex(slideIndex > 2 ? setSlideIndex +1 : 2)
}
